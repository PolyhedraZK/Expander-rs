...
impl<C: GKRConfig> RecursiveCircuit<C> {
    pub fn load(filename: &str) -> Self {
        ...
        let mut field_mod = [0u64; 4];
        field_mod[0] = u64::deserialize_from(&mut cursor);
        field_mod[1] = u64::deserialize_from(&mut cursor);
        field_mod[2] = u64::deserialize_from(&mut cursor);
        field_mod[3] = u64::deserialize_from(&mut cursor);
